...
public class MAXSwerveModule {
    ...
    // PID Controllers (ClosedLoopController)
    private final SparkClosedLoopController m_drivingClosedLoopController;
    private final SparkClosedLoopController m_turningClosedLoopController;
    
    // Variable to hold the current Absolute Encoder offset
    private double m_chassisAngularOffset = 0.0;

    // Variable to hold the current SwerveModuleState
    ...
    */
    public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
        ...
        m_turningEncoder = m_drivingSpark.getAbsoluteEncoder();

        // Instantiate PID (CloaseLoop) Controllers
    ...
    */
    public void setDesiredState(SwerveModuleState desiredState) {
        ...
        // Display the module state to Dashboard
        SmartDashboard.putString("Module State", desiredState.toString());
